...
public class Transaksi {
    ...
    public void prosesTransaksi(MemberR member, Transaksi transaksi, BarangG barang){
        Scanner myObj = new Scanner(System.in);
        System.out.println("Silahkan belanja");
        System.out.println("Masukkan ID Member");
        int idMember = myObj.nextInt();
        if (idMember>1){
            System.out.println("ID tidak ditemukan, mohon daftarkan diri terlebih dahulu");
            System.exit(0);
        }
        ...
        do{
            ...
            temp=myObj.nextInt();
            if (temp>2) {
                System.out.println("barang tidak ditemukan, silahkan coba lagi");
                System.exit(0);
            }
            if (temp!=99){
                idBarang.add(temp);
    ...
    public void setTransaksi(BarangG barang, int idMember, int idBarang, int banyaknya){
